...
public:
    ...
    Car(const Car &other)
        : Brand(other.Brand), Model(other.Model), rentalPrice(other.rentalPrice), availabilityStatus(other.availabilityStatus)
    {
    ...
    float applyDiscount(int days)
    {
        ...
        cout << "Total rental price after discount for " << days << " days: Rs " << finalPrice << endl;
        return finalPrice;
    }
    ...
    void displayDetails() const
    {
        cout << "Car: " << Brand << " " << Model << "Price: Rs " << rentalPrice << " | "
             << (availabilityStatus ? "Available" : "Not Available") << endl;
    }
};
